...
Actuators are used for moving the robot’s joints (such as picking up a block and placing it somewhere else). To be more specific, they require a control signal and a source of energy to provide a mechanical output. It is because of these actuators that robots can do work rather than just drive on the floor. A good analogy would be- Muscles are to humans as actuators are to robots.
<br /><br />
...
<br /><br />
Well does this picture remind you of Pascal’s Law, because if it does then you are going in the right direction. This is the basic principle of how hydraulic actuators work.
It consists of a cylinder or fluid motor that uses hydraulic power. As liquids are nearly impossible to compress, a hydraulic actuator can exert a large force. The drawback of this approach is its limited acceleration.
<br /><br />
...
Since leaks are of less concern with pneumatics, and they require low maintenance this makes them more suitable for robotics.<br />
<br />
<div class="blogPageSubHeading">Electrical:</div>
<br /><br />
An electric actuator is a mechanical device used to convert electricity into kinetic energy. You must have studied how motors work, so we won't go into the detail of how it works.
<br /><br />•	Alternating Current (AC) Motors- Synchronous, Asynchronous (since these are bulky and are of industrial use, we won’t discuss them here)
...
<br /><br />
DC motors are used often because of the ease of controlling speed and direction. They quickly respond to changes in the controlling signal.
<br /><br />
<strong>Brushed: </strong>
<br />
They are simple to construct, require no controllers and are cost-efficient motors. These motors generally have low torque and high speed. They, however, offer high resistance (due to the presence of brushes), causing a lot of heat dissipation and jerky motion. 
...
<br />Primary efficiency is a most important feature for BLDC motors. Because the rotor is the sole bearer of the magnets and it doesn’t require any power. i.e. no connections, no commutator and no brushes.
<br /><br />
<strong>Construction of Brushless DC motor</strong>
<br /><br />In this motor, the permanent magnets attach to the rotor. The current-carrying conductors or armature windings are located on the stator. They use electrical commutation to convert electrical energy into mechanical energy. 
...
The layout of a DC brushless motor can vary depending on whether it is in “Out runner” style or “Inrunner” style.<br />
<br /><strong>Outrunner</strong> – The field magnet is a drum rotor which rotates around the stator. This style is preferred for applications that require high torque and where high rpm isn’t a requirement.
<br /><strong>Inrunner</strong> – The stator is a fixed drum in which the field magnet rotates. This motor is known for producing less torque than the out runner style, but is capable of spinning at very high rpm.
...
When one pair of stator coils is at high voltage, the other two are at low voltage. This forms a moving electromagnet. The rotor rotates, when attracted to this moving electromagnet. These motors are less jerky and more power-efficient. They are more efficient at high speeds. 
<br /><br />
Uses: In multirotors, CD Drives, & Electric Vehicles
<br /><br />
<strong>ASSIGNMENT*: Question yourself, if BLDC motors are DC motors, why do they run on AC waveform? And if they do run on AC current, how do we decide the frequency of the waveform?</strong>
<br />
[Hint: ESC or Electronic Speed Controller are Inverters that are used with BLDCs to convert the DC Waveform into a Trapezoidal AC waveform.]
<br /><br />
...
<br />
<img src="../img/images/BME-blog/image45.jpg" class="img-responsive floating-image right" style="height:300px; width:300px;">
...
<strong>Thermal and Magnetic actuators:</strong>
<br /><br />
Actuators that can be actuated by applying thermal or magnetic energy to a solid-state material. Thermal actuators use shape-memory materials such as <strong>shape-memory alloy (SMAs).</strong>
<br />Here is how the training is done for the Thermal Actuators:
    ...
    <br />Similarly, magnetic actuators use <strong>Magnetic shape-memory alloys (MSMAs)</strong>. Objects made up of these materials are trained (by applying strong magnetic fields for the MSMAs) to take up a certain shape when introduced to some specific conditions.
