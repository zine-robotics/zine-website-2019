...
Now we are towards the end of our blogs on the heart of robotics. In this blog you are going to learn about various instruments which you are going to use to make your little robots ready for a fight in the arena.
<br />
...
<br />
In electronics, joints are made with the help of a process called soldering. Let’s dive to make joints, soldering joints 😏.
<div class="blogPageHeading">Soldering</div>

<br />Rome was not built in a day and so weren’t our exciting robots which crushed every competitor in every competition they participated in. The controlling unit of our robots consists of various electronic components and combining them magically requires an elder wand and a magical fuel which is known as “Soldering Iron” and “solder” respectively in the Geek circle.
<br /><img src="./images/Instruments/image24.gif" class="img-responsive floating-image right"> <br />Various components have to be joined via a conductive link and in our case, the solder does the job, it is a highly conductive material with a low melting point.
<br />The process in which two or more items are joined together (electronic components and boards) by melting and putting a filler metal also known as solder into the joint, the filler metal having a lower melting point than the adjoining metal i.e terminals of component or Circuit board is called Soldering. 
...
<br />
<br />Above is the gif showing soldering on an oxidized metal surface (top) and soldering on the same surface after applying flux (bottom).
<img src="./images/Instruments/image12.png" class="img-responsive floating-image right"><br /><br />
Solder wires available these days already have flux at their core to ease the work of soldering. Flux automatically cleans the area while using such solder wire making sites prepared for soldering.
<br />External flux paste of rosin and liquid flux is also available in the market.

<br /><br /><br /><br />


If you’re wondering how to solder components like professionals, <a href="https://www.youtube.com/watch?v=6rmErwU5E-k">this video will help you.</a>
<br />
...
<br />
To make our circuits more robust, portable and convenient, with ease of making. We require a base. Circuit boards are the base for circuits, a board on which we design our circuits. They are categorized in three types are as follows:
...
Unlike the ones we would be making, we aren’t robots so we’re susceptible to make mistakes. Taking all the components we “think” we require and straightaway soldering them according to the way we “presume” could be a risky affair, and making mistakes at that stage would result in sacrificing several important and sometimes valuable components, so we tend to make a prototype and test our circuit design and functioning before permanently soldering them together. To make such prototypes, we tend to use a breadboard.
<br />A breadboard refers to a solder-free, plug-and-play platform allowing for speedy insertion and removal of electrical components in circuit-building applications. The breadboard has strips of metal underneath the board and connects the holes on the top of the board. The metal strips are laid out as shown below. Note that the top and bottom rows of holes are connected horizontally and split in the middle while the remaining holes are connected vertically.
...
<br />	This is how an IC is used on a breadboard. And above mentioned are the internal connections of a breadboard. The colored lines show the connected pins of the breadboard. As a convention, pins on the right of the red line are used for positive terminals and pins at the left of blue line are used for negative terminals. Vertical lines are called power rails due to this reason and horizontal lines are called component rails as electrical and electronic components are used on thes rails/lines. 
<br />But can you figure out why there is a channel in the middle of the breadboard. Think!<br /><br />
<img src="./images/Instruments/image20.jpg" class="img-responsive floating-image right" style="height:300px; width:300px;">
<div class="blogPageSubHeading">Stripboard</div>
<br />Stripboard is one of the commonly-used types of prototyping boards. These boards are intended for permanently assembling one-off circuits, especially prototypes. The board is made from an insulating material, usually a resin-bonded plastic or fiberglass. One side has parallel copper strips on it, spaced 2.54 mm apart. There are holes bored in these strips, also 2.54 mm apart. Components are placed on the other side of the board with their wires bent to pass through the holes. The wires are soldered to the copper strips, the projecting ends being cut off to make the assembly neater. Only the shiny part with copper plated strips can get soldered, the other side with no copper plating cannot be soldered so components must be inserted and soldered with care.
<img src="./images/Instruments/image21.png" class="img-responsive floating-image left" ><br />The strips correspond to the rows of sockets on breadboards, allowing several components to be joined together, but a strip has many more than five holes so numerous connections are possible. Using a special tool, strips can be cut into shorter lengths where it is necessary to use one strip for making several different connections. A circuit built on a stripboard has permanently soldered connections, but it is not difficult to remove a component and solder in one of a different value, or even to completely modify part of the circuit. A prototype circuit may be built and tested stage by stage.
<br /><br /><br />
<img src="./images/Instruments/image8.png" class="img-responsive floating-image right" style="height:200px; width:300px;" >

<div class="blogPageSubHeading">PCB</div><br />
You must have encountered some green, red or blue colored boards inside electronic devices having shiny lines with components on them. These are the highly robust and portable circuit boards. They are PCBs or printed circuit boards.
It is a board that has lines and pads that connect various points together.  In the picture, there are traces that electrically connect the various connectors and components to each other.
<img src="./images/Instruments/image23.png" class="img-responsive floating-image left" > It allows signals and power to be routed between physical devices. Solder makes the electrical connections between the surface of the PCB and the electronic components. Being metal, solder also serves as a strong mechanical adhesive. A PCB is printed with the help of a printing machine but the PCBs are first designed in CAD softwares like EAGLE, KiCAD, etc. and then these software aid the printing of PCBs.

<br /> <br />PCB is composed of four layers usually stacked on one another as shown in left. <br />
<br /># Substrate is the very base of PCB that provides strength to the PCB and support to its components. It is usually made of fiberglass.
<br /># A layer of copper is fabricated above the substrate of PCB which makes the conductive electrical paths of circuit boards. Some boards with dual side circuitry have both sides fabricated with copper layers so that components can be soldered on both sides.
<br /># A solder mask is applied above the copper layer so as to prevent it from shorting from external metals and also it acts as a protective mask for copper from being damaged physically and chemically making the circuit path undisturbed.
<br /># A white layer of silk screen is used to print visuals on the circuit board above the solder mask which helps the manufacturer or designer to share info about component values or placement directly via board.
