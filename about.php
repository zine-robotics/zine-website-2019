...
<body class="no-loader">
	...
	<div class="main-container">
		...
		<section class="lightbox-gallery preserve-3d lazy-section">
				...
				<div class="row">
					<div class="col-sm-12">
						<div>
							...
							<h1 class="text-white">Memories from ZINE Events<br></h1>
							<span class="lead text-white">Follow our photostream on <strong>Social Platforms for more...</strong></span>
						</div>
					</div>
				</div>
			</div>
