...
<div class="page">
    ...
    <br /><br />Now the applications of algorithms and pseudocodes in robotics are too vast to even list. However, we shall take a small peek at one particular one. The first love of every robotics aficionado, welcome to the world of Arduino!
    ...
    <br />
    <br />The robot is in the square-shaped box and has to return to the circle after navigating each and every path i.e.- it has to visit every node.
    <br /> <br />Using the full use of the features that your robot possesses, write a pseudocode/algorithm and submit your answer attached. 
    <br /> <br />
